...
#define musb_dma_ux500(musb)		(USB_HAS_QUIRK(musb->ops, MUSB_DMA_UX500))
#else
#define musb_dma_ux500(musb)		0
#endif

#ifdef CONFIG_USB_TI_CPPI41_DMA
#define musb_dma_cppi41(musb)		(USB_HAS_QUIRK(musb->ops, MUSB_DMA_CPPI41))
#else
#define musb_dma_cppi41(musb)		0
#endif

#ifdef CONFIG_USB_TI_CPPI_DMA
#define musb_dma_cppi(musb)		(USB_HAS_QUIRK(musb->ops, MUSB_DMA_CPPI))
#else
#define musb_dma_cppi(musb)		0
#endif

#ifdef CONFIG_USB_TUSB_OMAP_DMA
#define tusb_dma_omap(musb)		(USB_HAS_QUIRK(musb->ops, MUSB_DMA_TUSB_OMAP))
#else
#define tusb_dma_omap(musb)		0
#endif

#ifdef CONFIG_USB_INVENTRA_DMA
#define musb_dma_inventra(musb)		(USB_HAS_QUIRK(musb->ops, MUSB_DMA_INVENTRA))
#else
